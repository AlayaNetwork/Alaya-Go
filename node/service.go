...
func NewServiceContextWithPubSubServer(config *Config, services map[reflect.Type]Service, EventMux *event.TypeMux, AccountManager *accounts.Manager, pubSubServer *p2p.PubSubServer) *ServiceContext {
	return &ServiceContext{
		config:         config,
		services:       services,
		EventMux:       EventMux,
