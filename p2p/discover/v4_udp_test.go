...
func TestUDPv4_findnodeMultiReply(t *testing.T) {
	...
	test.packetIn(nil, p_neighborsV4, &neighborsV4{Expiration: futureExp, Nodes: rpclist[:2], Rest: cRest})
	test.packetIn(nil, p_neighborsV4, &neighborsV4{Expiration: futureExp, Nodes: rpclist[2:], Rest: cRest})
...
func TestUDPv4_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, p_pingV4, &pingV4{From: testRemote, To: testLocalAnnounced, Version: 4, Expiration: futureExp, Rest: cRest})
	...
	test.waitPacketOut(func(p *pingV4, to *net.UDPAddr, hash []byte) {
		...
		test.packetIn(nil, p_pongV4, &pongV4{ReplyTok: hash, Expiration: futureExp, Rest: cRest})
	})
