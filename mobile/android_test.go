...
func TestAndroid(t *testing.T) {
	...
	workspace, err := ioutil.TempDir("", "alaya-android-")
	if err != nil {
	...
	build.CopyFile(filepath.Join("libs", "alaya.aar"), "alaya.aar", os.ModePerm)
