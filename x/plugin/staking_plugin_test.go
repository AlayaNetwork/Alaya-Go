...
func TestStakingPlugin_WithdrewDelegation(t *testing.T) {
	...
	*/
	...
	_, err = StakingInstance().WithdrewDelegation(state, blockHash2, blockNumber2, txHashArr[2], amount, addrArr[index+1],
	...
	issueIncome, err := StakingInstance().WithdrewDelegation(state, blockHash3, curBlockNumber, txHashArr[3], del.ReleasedHes, addrArr[index+1],
