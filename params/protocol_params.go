...
const (
	...
	WithdrewDelegationGas uint64 = 8000  // Gas needed for withdrewDelegation
	...
	PoseidonBaseGas     uint64 = 1800 // Once per poseidon operation.
	PoseidonPerWordGas uint64 = 360  // Once per word of the poseidon hash operation's data.
)
