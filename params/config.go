...
type CbftConfig struct {
	...
	GroupValidatorsLimit uint8	`json:"GroupValidatorsLimit,omitempty"` //Max validators per group
	CoordinatorLimit uint8	`json:"CoordinatorLimit,omitempty"` //Coordinators Limit C0>C1>C2...
}
