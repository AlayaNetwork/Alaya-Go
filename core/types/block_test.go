...
func TestBlockEncoding(t *testing.T) {
	...
	check("Coinbase", block.Coinbase(), common.MustBech32ToAddress("atx13zy0ruv447se9nlwscrfskzvqv85e8d3ga9ph9"))
	...
	tx1 := NewTransaction(0, common.MustBech32ToAddress("atx1p908ht4x5mrufsklawtha7kry6h42tv8vn770j"), big.NewInt(10), 50000, big.NewInt(10), nil)
